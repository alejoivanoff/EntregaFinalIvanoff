...
// Obtener productos del localStorage al cargar la página
const cartProducts = JSON.parse(localStorage.getItem('productos'));
if (cartProducts) {
...
btnVaciarCarrito.addEventListener('click', () => {
    allProducts = []; // Vaciar el arreglo de productos
...
rowProduct.addEventListener('click', (e) => {
    if (e.target.classList.contains('icon-close')) {
        ...
        const productIndex = Array.from(rowProduct.children).indexOf(productElement);
